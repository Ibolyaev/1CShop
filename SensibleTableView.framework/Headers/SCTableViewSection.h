...
// internal
- (void)setBoundObject:(NSObject *)boundObject withStore:(SCDataStore *)boundObjectStore autoGenerateCells:(BOOL)autoGenerateCells;
 ...
 *	@param item The item that the model should be built for. If item is nil, a model should be built for a new item. */
 ...
 *	@param detailViewController The generated detail view.
 *	@param item The item that the detail view is generated for.
 *  @param newItem TRUE if the item is a newly created item.
 */
 ...
 *	@param detailTableModel The model to be configured.
 *	@param item The item that the model is configured for.
 */
